...
def parse_option():
    ...
    parser.add_argument('--train_teacher', type=eval, choices=[True, False], default='True', help='This is a boolean flag.')
    ...
    parser.add_argument('--model', type=str, default='resnet110',
                        choices=['resnet8', 'resnet14', 'resnet20', 'resnet32', 'resnet44', 'resnet56', 'resnet110',
                                 ...
                                 'MobileNetV2', 'ShuffleV1', 'ShuffleV2', 'resnet50', 'Teacher', 'CNN_RIS'])
    parser.add_argument('--dataset', type=str, default='TinyImageNet', choices=['cifar100', 'CAR196', 'SVHN', 'CINIC10',
                                                                                'TinyImageNet', 'CelebA', 'Food',
                                                                                'Places_Extra69', 'FairFace'], help='dataset')
