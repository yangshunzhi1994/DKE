...
from dataset.randaugment import PolicyDatasetImageNet
...
def get_imagenet_dataloader(dataset='imagenet', batch_size=128, num_workers=16, use_DA=False, multiple='2X'):
    """
    ...
    if use_DA:
        train_set = PolicyDatasetImageNet(train_set, multiple)
