...
from dataset.randaugment import PolicyDatasetC100
...
def get_cifar100_dataloaders(batch_size=128, num_workers=4, is_instance=False, use_DA=False, multiple='2X'):
    """
    cifar 100
    """
    ...
    if use_DA:
        train_set = PolicyDatasetC100(train_set, multiple)
